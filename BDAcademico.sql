...
insert into TCarrera Values ('C01','Ingenier�a de Sistemas')
insert into TCarrera values ('C02','Ingenier�a Industrial')
insert into TCarrera values ('C03','Ingenier�a Civil')
go
